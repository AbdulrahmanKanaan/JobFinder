...
<div class="my-5">
    <div class="container">
    <a href="<?php echo URLROOT . '/cvs/show/' . $_SESSION['curID']; ?>" class="btn btn-secondary mb-3"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
        <div class="card card-body bg-light">
            <h2 class="card-title">Add To Your CV</h2>
            <p>Fill this form to add a new achievment to your cv</p>
            <form action="<?php echo URLROOT . '/CVs/add' ?>" method="POST">
